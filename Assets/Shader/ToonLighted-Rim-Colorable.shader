Shader "Toon/Lighted-Rim-Colorable" {
	Properties {
		...
		Pass {
			...
			Program "vp" {
				SubProgram "gles hw_tier00 " {
					...
					uniform lowp sampler2D _RimRamp;
				...
				SubProgram "gles3 hw_tier00 " {
					...
					uniform 	mediump vec4 _LightColor0;
					uniform 	mediump vec4 _Color;
					UNITY_LOCATION(0) uniform mediump sampler2D _RimRamp;
					...
					void main()
					{
					    ...
					    u_xlat0.x = dot(u_xlat0.xyz, vs_TEXCOORD0.xyz);
					    u_xlat0.x = (-u_xlat0.x) + 1.0;
					    u_xlat16_0.xyz = texture(_RimRamp, u_xlat0.xx).xyz;
					    u_xlat16_1.x = dot(vs_TEXCOORD0.xyz, _WorldSpaceLightPos0.xyz);
					    u_xlat16_1.x = u_xlat16_1.x * 0.5 + 0.5;
					    u_xlat16_2.xyz = texture(_Ramp, u_xlat16_1.xx).xyz;
					    u_xlat16_1.xyz = _LightColor0.xyz * _Color.xyz;
				...
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat10_1.xyz = texture2D(_Ramp, u_xlat16_5.xx).xyz;
					    u_xlat16_5.xyz = _LightColor0.xyz * _Color.xyz;
					    u_xlat16_5.xyz = u_xlat10_1.xyz * u_xlat16_5.xyz;
					    u_xlat16_2.xyz = u_xlat16_2.xxx * u_xlat16_5.xyz;
					    u_xlat16_2.xyz = _Color.xyz * vs_TEXCOORD2.xyz + u_xlat16_2.xyz;
				...
				SubProgram "gles3 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat16_4.x = dot(vs_TEXCOORD0.xyz, _WorldSpaceLightPos0.xyz);
					    u_xlat16_4.x = u_xlat16_4.x * 0.5 + 0.5;
					    u_xlat16_2.xyz = texture(_Ramp, u_xlat16_4.xx).xyz;
			...
			Program "vp" {
				...
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat16_0.xyz = _LightColor0.xyz * _Color.xyz;
				...
				SubProgram "gles3 hw_tier00 " {
					...
					uniform 	mediump vec4 _LightColor0;
					uniform 	mediump vec4 _Color;
					UNITY_LOCATION(0) uniform mediump sampler2D _Ramp;
					in highp vec3 vs_TEXCOORD0;
					layout(location = 0) out mediump vec4 SV_Target0;
					mediump vec3 u_xlat16_0;
					mediump vec3 u_xlat16_1;
				...
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat10_0.xyz = texture2D(_Ramp, u_xlat16_3.xx).xyz;
				...
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat0.x = dot(vs_TEXCOORD2.xyz, vs_TEXCOORD2.xyz);
					    u_xlat0.x = texture2D(_LightTextureB0, u_xlat0.xx).x;
					    u_xlat2 = textureCube(_LightTexture0, vs_TEXCOORD2.xyz).w;
				...
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat1 = texture2D(_LightTexture0, vs_TEXCOORD2.xy).w;
				...
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat16_0.xyz = _LightColor0.xyz * _Color.xyz;
					    u_xlat16_0.xyz = u_xlat10_1.xyz * u_xlat16_0.xyz;
					    u_xlat1.x = texture2D(_LightTexture0, vs_TEXCOORD2.xy).w;
